...
class Read extends Component {
  render() {
    let showingBooks = this.props.read
    ...
    return (
      <div className="bookshelf">
        ...
        <div className="bookshelf-books">
          ...
          {showingBooks.map((read) => (
            <li key={read.id}>
              <div className="book">
                <div className="book-top">
                  <div className="book-cover" style={{ width: 128, height: 192, backgroundImage: `url(${read.imageLinks.thumbnail})` }} />
