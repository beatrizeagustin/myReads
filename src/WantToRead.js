...
class MyReads extends Component {
  render() {
    let showingBooks = this.props.wantToRead
    return (
      <div className="bookshelf">
        ...
        <div className="bookshelf-books">
          ...
          {showingBooks.map((wantToRead) => (
            <li key={wantToRead.id}>
              <div className="book">
                <div className="book-top">
                  <div className="book-cover" style={{ width: 128, height: 192, backgroundImage: `url(${wantToRead.imageLinks.thumbnail})` }} />
